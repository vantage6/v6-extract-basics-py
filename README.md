...
This algorithm makes the extraction functions defined in the vantage6 algorithm tools available in an algorithm image.
...
This algorithm is available as the `ghcr.io/vantage6/algorithm/extract-basics` image.
